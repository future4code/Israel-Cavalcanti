...
// ======================== HOME
// ========================
export const ContainerHomePage = styled.body`
  display: flex;
...
export const ContainerMediumHome = styled.div`
  display: flex;
  flex-direction: row;
  justify-content: center;
  align-items: center;
...
// ======================== CREATE TRIP PAGE
// ========================
export const ContainerCreateTripPage = styled.body`
  display: flex;
  flex-direction: column;
...
// ======================== LIST TRIPS
// ========================
export const ContainerListTripPage = styled.body`
  display: flex;
  flex-direction: column;
  background-image: url("https://wgntv.com/wp-content/uploads/sites/5/2019/11/s116536929.jpg?w=2560&h=1440&crop=1");
  width: 100vw;
